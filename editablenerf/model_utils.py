...
def compute_opaqueness_mask(weights, depth_threshold=0.5):  # ZCW change 0.5
...
def compute_depth_index(weights, depth_threshold=0.5):  # ZCW change 0.5
...
def compute_depth_map(weights, z_vals, depth_threshold=0.5):  # ZCW change 0.5
